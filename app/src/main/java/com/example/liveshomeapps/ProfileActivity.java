...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String image_url = "https://dharnisha250665.000webhostapp.com/profileimages/" + phone + ".jpg";
    ...
    void loadUserProfile() {
        class LoadUserProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest("https:/dharnisha250665.000webhostapp.com/load_user.php", hashMap);
                return s;
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    JSONArray donarray = jsonObject.getJSONArray("user");
                    JSONObject c = donarray.getJSONObject(0);
    ...
    void updateProfile(final String newemail, final String newname, final String newloc, final String oldpass, final String newpass) {
        class UpdateProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("https://dharnisha250665.000webhostapp.com/update_profile.php", hashMap);
                return s;
            }
