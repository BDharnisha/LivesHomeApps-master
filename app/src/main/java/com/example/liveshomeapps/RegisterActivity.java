...
public class RegisterActivity extends AppCompatActivity {
    Spinner sphome,spposition,sploc;
    ...
    private void registerUserInput() {
        String email,pass,phone,name,homename,location,position;
        email = edEmail.getText().toString();
        pass = edPass.getText().toString();
        phone = edPhone.getText().toString();
        name = edName.getText().toString();
        homename = sphome.getSelectedItem().toString();
        location = sploc.getSelectedItem().toString();
        position = spposition.getSelectedItem().toString();


        user = new User(name,phone,email,pass,homename,location,position,hlatitude,hlongitude);
        //insertData(user);
        insertData();
        registerUserDialog();
    }
    ...
    private void insertData() {
        class RegisterUser extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                hashMap.put("homename",user.homename);
                hashMap.put("location",user.location);
                hashMap.put("position",user.position);
                hashMap.put("latitude",user.latitude);
                hashMap.put("longitude",user.longitude);

                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest
                        ("https://dharnisha250665.000webhostapp.com/insert_registration.php",hashMap);
    ...
    private void initView() {
        sphome = findViewById(R.id.spinHomeName);
        sploc = findViewById(R.id.spinLocation);
        spposition = findViewById(R.id.spinPosition);
        ...
        private void makeRequest(final String encoded_string, final String image_name) {
            class UploadAll extends AsyncTask<Void, Void, String> {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    String s = rh.sendPostRequest("https://dharnisha250665.000webhostapp.com/upload_image.php", map);
                    return s;
                }
                @Override
                protected void onPostExecute(String s) {
